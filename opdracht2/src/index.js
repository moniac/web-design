...
const label = document.querySelector('.open p a')
...
// grab an element
var myElement = document.querySelector('header footer')
...
const link = document.querySelector('.open > p > a')

link.addEventListener('click', function() {
	setTimeout(() => {
		this.parentElement.parentElement.style.transform = 'translateY(-200%)'
		this.parentElement.parentElement.style.opacity = 0
	}, 400)
})

close.addEventListener('click', function() {
	this.parentElement.style.transform = 'translateY(-200%)'
	setTimeout(() => {
