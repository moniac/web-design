					...
					(r = (function() {
						function t(t, e) {
							(this.el = t),
								(this.name = e),
								(this.templateValue =
									this.el.getAttribute(this.name) || '');
						}
						return (
					...
					(o = (function(t) {
						function e(t, e) {
							(this.el = t),
								(this.name = e),
								(this.templateValue =
									this.el.getAttribute(this.name) || !1);
						}
						var n, r, o, s;
						for (
							c(e, t),
					...
					(e.exports = r = (function() {
						function t(t, e) {
							(this.el = t),
								...
								(this.instances = [
									new i(this.el, this.Transparency)
								]),
								(this.instanceCache = []);
						}
						var e, n;
		...
		4: [
			function(t, e, n) {
				...
				(p = t('../lib/lodash.js')),
					...
					(c = (function(t) {
						function e() {
							return e.__super__.constructor.apply(
								this,
								arguments
							);
						}
			...
			function(t, e, n) {
				...
				(r = t('./elementFactory')),
					...
					(s = function() {
						return (
							'<:nav></:nav>' !==
							document.createElement('nav').cloneNode(!0)
								.outerHTML
						);
					}),
					(n.cloneNode =
						...
						return (
							(t.prototype.remove = o(function() {
								...
								for (
									...
									(n = r[t]),
										i.push(n.parentNode.removeChild(n));
								return i;
							})),
							...
							(t.prototype.renderDirectives = o(function(
								t,
								e,
								n
							) {
							...
							(t.prototype.renderChildren = o(function(
								t,
								e,
								n,
								r
